...
def regressionBonusAndSalary():
    ...
    #find score the performance on the train data
    #print reg.score(feature_train, target_train)
    # find score on the test data
...
'''
regression of bonus against the long term incentive
'''
...
if __name__=="__main__":
    #regressionBonusAndLongTermInc()
    regressionBonusAndSalary()
