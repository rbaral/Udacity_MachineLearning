...
if len(cleaned_data) > 0:
    print cleaned_data
    #ages, net_worths, errors = zip(*cleaned_data) # commented because zip gave too many values to unpack error # fix it later
    ages = cleaned_data[0]
